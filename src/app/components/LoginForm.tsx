...
export default function LoginForm({ onLoginSuccess }: LoginFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-6 space-y-4 bg-white dark:bg-zinc-800 rounded-lg shadow-md">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-red-600 dark:text-red-400 mt-0.5">
              Verifique os dados e tente novamente. Use &quot;Esqueci minha senha&quot; se precisar.
            </p>
            <button
              type="button"
      ...
      {showResetPassword && (
        <div className="mt-4 p-4 bg-zinc-50 dark:bg-zinc-900 rounded-lg border border-zinc-300 dark:border-zinc-600">
          ...
          <form onSubmit={handleResetPassword} className="space-y-3">
            <input
              ...
              className="w-full px-3 py-2 border border-zinc-300 dark:border-zinc-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 bg-zinc-50 dark:bg-zinc-700 text-zinc-900 dark:text-zinc-100"
              required
            />
            {resetMessage && (
              <div
            ...
            <div className="flex gap-2">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 px-4 py-2 rounded-md bg-indigo-600 text-white text-sm font-medium hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <button
                ...
                className="px-4 py-2 rounded-md border border-zinc-300 dark:border-zinc-600 text-zinc-700 dark:text-zinc-300 text-sm font-medium hover:bg-zinc-50 dark:hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                Cancelar
              </button>
            </div>
